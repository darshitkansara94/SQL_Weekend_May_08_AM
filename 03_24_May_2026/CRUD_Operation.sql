...
When we need to insert, read, update or delete data from the table.
	...
	-- Create (Insert) :
		...
		-- Example :
			...
			-- Error statement
			Insert into tbl_EmployeeMaster(Employee_Id,Employee_Name,Employee_Age)
			values(2,'Harsh',26,'abc@gmail.com')

			-- Insert multiple rows using single execution
			Insert into tbl_EmployeeMaster(Employee_Id,Employee_Name)
